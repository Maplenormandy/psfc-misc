...
def plotHysteresis(shot):
    ...
    vlow = np.searchsorted(vtime, 0.45)
    vhigh = np.searchsorted(vtime, 1.55)
    ...
    return np.array([nlData, vdata+offset, vtime])

hys01 = plotHysteresis(1160506007)
hys02 = plotHysteresis(1160506008)
hys03 = plotHysteresis(1160506024)

np.savez('figure2_aps.npz', hys01=hys01,hys02=hys02,hys03=hys03)
