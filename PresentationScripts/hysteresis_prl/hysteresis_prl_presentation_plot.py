...
ax12.text(0.99, 0.11, '1120106012', transform=ax12.transAxes, horizontalalignment='right', verticalalignment='bottom', fontdict={'size': 6}, color='b')
ax12.text(0.99, 0.01, '1120106016', transform=ax12.transAxes, horizontalalignment='right', verticalalignment='bottom', fontdict={'size': 6}, color='r')
...
ax311.axvspan(0.35, 0.4, color=(1.0, 0.75, 0.5))
ax302.axvspan(0.35, 0.4, color=(1.0, 0.75, 0.5))
ax312.axvspan(0.35, 0.4, color=(1.0, 0.75, 0.5))

ax300.axvline(0.575, color=(0.7, 1.0, 1.0), ls='--')
ax301.axvline(0.575, color=(0.7, 1.0, 1.0), ls='--')
ax310.axvline(0.575, color=(0.7, 1.0, 1.0), ls='--')
...
"""
ax300.errorbar(r3, fig3_profs[1,:], yerr=2*fig3_profs[2,:], c='r', linewidth=0.8)
ax300.errorbar(r3, fig3_profs[3,:], yerr=2*fig3_profs[4,:], c='b', linewidth=0.8)
...
ax301.errorbar(r3, fig3_profs[9,:], yerr=fig3_profs[10,:], c='r', linewidth=0.8)
ax301.errorbar(r3, fig3_profs[11,:], yerr=fig3_profs[12,:], c='b', linewidth=0.8)

ax311.errorbar(r3, fig3_profs[13,:], yerr=5*fig3_profs[14,:], c='r', linewidth=0.8)
ax311.errorbar(r3, fig3_profs[15,:], yerr=5*fig3_profs[16,:], c='b', linewidth=0.8)
"""

ax300.errorbar(fig3_fs['loc_ne_x'][0:max_ind:8], fig3_fs['loc_ne_y'][0:max_ind:8], yerr=fig3_fs['loc_ne_err_y'][0:max_ind:8], c='r', linewidth=0.8)
ax300.errorbar(fig3_fs['soc_ne_x'][0:max_ind:8], fig3_fs['soc_ne_y'][0:max_ind:8], yerr=fig3_fs['soc_ne_err_y'][0:max_ind:8], c='b', linewidth=0.8)
...
ax301.errorbar(fig3_fs['loc_te_x'][0:max_ind:8], fig3_fs['loc_te_y'][0:max_ind:8], yerr=fig3_fs['loc_te_err_y'][0:max_ind:8], c='r', linewidth=0.8)
ax301.errorbar(fig3_fs['soc_te_x'][0:max_ind:8], fig3_fs['soc_te_y'][0:max_ind:8], yerr=fig3_fs['soc_te_err_y'][0:max_ind:8], c='b', linewidth=0.8)

ax311.errorbar(fig3_fs['loc_te_x'][0:max_ind:8], fig3_fs['loc_te_a_Ly'][0:max_ind:8], yerr=fig3_fs['loc_te_err_a_Ly'][0:max_ind:8], c='r', linewidth=0.8)
ax311.errorbar(fig3_fs['soc_te_x'][0:max_ind:8], fig3_fs['soc_te_a_Ly'][0:max_ind:8], yerr=fig3_fs['soc_te_err_a_Ly'][0:max_ind:8], c='b', linewidth=0.8)
...
ax302.errorbar(fig32['loc_rho'], fig32['loc_prof'], fig32['loc_err'], c='r', linewidth=0.8)
ax302.errorbar(fig32['soc_rho'], fig32['soc_prof'], fig32['soc_err'], c='b', linewidth=0.8)

ax312.errorbar(fig32['loc_rho'], fig32['alti_loc'], fig32['alti_loc_err'], c='r', linewidth=0.8)
ax312.errorbar(fig32['soc_rho'], fig32['alti_soc'], fig32['alti_soc_err'], c='b', linewidth=0.8)

ax300.set_xlim([0.0, 1.0])
ax310.set_ylim([-0.05, 2.2])
...
ax311.text(0.99, 0.11, '1160506007', transform=ax311.transAxes, horizontalalignment='right', verticalalignment='bottom', fontdict={'size': 6})
ax311.text(0.75, 0.01, '0.6s', transform=ax311.transAxes, horizontalalignment='right', verticalalignment='bottom', fontdict={'size': 6}, color='b')
ax311.text(0.99, 0.01, '0.96s', transform=ax311.transAxes, horizontalalignment='right', verticalalignment='bottom', fontdict={'size': 6}, color='r')
